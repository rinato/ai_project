...
### 9/07 회의
  ...
  1. 진행사항 공유
    ...
    2) 화이팅
      - (진행)딥러닝 cnn 완벽가이드 - 섹션 5완료
      - (목표)딥러닝 cnn 완벽가이드 - 섹션 6, 7 완료
      
    3) 다다
      - (진행)파이썬 머신러닝 완벽 가이드 - 섹션 4 완료
      - (목표)파이썬 머신러닝 완벽 가이드 - 섹션5 1/2완강
      
### 9/14 회의

  공통 목표 - 결과물을 낼 수 있는 프로젝트 고민
  - kaggle 대회 참여해보기
  - 딥러닝 컴퓨터 비전 이미지 처리(추후 OpenCV 진행)
  - 차주 추석인 관계로 날짜 조정(임시 23일)

  1. 진행사항 공유

    1) 현
      - (진행)파이썬 머신러닝 완벽 가이드 - 섹션3 완강 34/123
      - (목표)파이썬 머신러닝 완벽 가이드 - 섹션4-10 44/123
      
    2) 화이팅
      - (진행)딥러닝 cnn 완벽가이드 - 6섹션 완료. 7섹션 5강까지
      - (목표)딥러닝 cnn 완벽가이드 - 7, 8, 9섹션 완료
      
    3) 다다
      - (진행)파이썬 머신러닝 완벽 가이드 - 섹션 5 1/4 완강
      - (목표)파이썬 머신러닝 완벽 가이드 - 섹션 1-4 복습  섹션5 1/4 완료
...
### 10/02 회의
  ...
  1. 진행사항 공유
    ...
    1) 현
      - (진행)파이썬 머신러닝 완벽 가이드 - 섹션4 진행중
      - (목표)파이썬 머신러닝 완벽 가이드 - 섹션4 진행중
              kaggle 대회 참여에 중점
      
    2) 화이팅
      - (진행)딥러닝 cnn 완벽가이드 - 7, 8, 9섹션 완료
      - (목표)딥러닝 cnn 완벽가이드 - 마무리
              kaggle 대회 참여에 중점
      
    3) 다다
      - (진행)파이썬 머신러닝 완벽 가이드 - 강의 진행
      - (목표)파이썬 머신러닝 완벽 가이드 - 강의 진행
             시험기간(~10/25)
